...
public class Utils {
	...
	public static String intToHex(int anInt) {
		String ret = new String();
		for (int i = 0; i < 32; i+=4) {
			ret = hexArray[(int) ((anInt >>> i) & 0x0000000F)] + ret;
		}
		return ret;
	}
	
	public static String longToHex(long anLong) {
		String ret = new String();
		for (int i = 0; i < 64; i+=4) {
			ret = hexArray[(int) ((anLong >>> i) & 0x0000000F)] + ret;
		}
		return ret;
	}
